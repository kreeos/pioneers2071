...
class List extends Component {
  ...
  handleSubmit(event) {
    if (this.state.value === "zkdltmxm2020") this.setState({ isAuthed: true });
    else alert("Incorrect Password. Please check again.");
              ...
              {(close) => (
                <div className="list-modal">
                  <form onSubmit={this.handleSubmit}>
                    <div className="modal-header"> Password </div>
