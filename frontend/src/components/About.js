          ...
          <div className="category-div">
            ...
            <div className="category-text">
              <a>
                ...
                resolve the issues described in the scenario in preparation for
                the conference. Teams then present their ideas and debate how
          ...
          <div className="category-div">
            ...
            <div className="category-text">
              <a>
                ...
                judges. Voters receive different points based on the status of
                the team that they support being advanced to the final or
                receiving a reward.
              </a>
            </div>
          </div>
