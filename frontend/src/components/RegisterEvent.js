  ...
  sendRequest = async (newApplicant) => {
    try {
      const resp = await axios.post(
        "https://pioneers.kaist.ac.kr:8000/api/register/event/post",
        newApplicant
      );
      if (resp.status == 200) window.location.href = "/complete";
            ...
            <form onSubmit={this.handleSubmit} style={{ width: "100%" }}>
              <div className="information-container">
                ...
                <div className="information-section-container">
                  ...
                  <div className="div-input-horizontal">
                    ...
                    <div className="input-container">
                      <label className="input-label-half-right">City *</label>
                      <input
                        defaultValue=""
                        type="text"
                        name="city"
              ...
              <div className="information-container">
                ...
                <div className="information-section-container">
                  ...
                  <div className="div-input-horizontal">
                    <div className="input-container">
                      <label className="input-label">Scenario Preference</label>
                      <select
                        name="preference"
                        defaultValue=""
                        onChange={this.handleChange}
                  ...
                  <div className="div-input-horizontal">
                    <div className="input-container">
                      ...
                      <input
                        ...
                        type="text"
                        name="memone"
                        placeholder="Enter your team member 1 (your name) *"
                        className="register-input-half"
                        onChange={this.handleChange}
                      />
                    </div>
                    <div className="input-container">
                      <label
                        className="input-label-half-right"
              ...
              <div className="information-container">
                ...
                <div className="information-section-container">
                  ...
                  <div className="input-container">
                    ...
                    >
                      ...
                      <option value="website">
                        PIONEERS 2071 Official Website
                      </option>
                      <option value="invite">
                        Invited by the PIONEERS 2071 Team
                      </option>
                  ...
                  <div
                    className={
                      this.state.other ? "input-container" : "hidden-div"
                    }
                  >
              ...
              <div style={{ fontSize: "1.1rem" }}>
                ...
                <a
                  ...
                  target="blank"
                  href="https://drive.google.com/drive/folders/17wpEhO4ruf-v28venhf5SVffwd9ybHiQ?usp=sharing"
                >
